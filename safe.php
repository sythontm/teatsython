<?php
ob_start();
$API_KEY = "5607739160:AAH3WU9dmV7QPsmOyrq4pNa4B6KCuWJAIXg";
$sudo = 5159123009;
...
$Dev = array("5159123009","637549705","637549705"); 
$bot_id = "5607739160";
$buyy = "@T_4_Z";
@$usernamebot = "testsythonbot"; //UserName Bot
@$channel = "sythontm"; // UserName Channel don't @
@$token = API_KEY;
...
'disable_web_page_preview'=>true,
        ...
        'reply_markup'=>json_encode([
          'inline_keyboard'=>[  
                [['text'=>'• قناة السورس •','url'=>'https://t.me/THTSS']],
               ]
        ])
    ]);
}
